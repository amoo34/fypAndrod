...
public class ReviewListUserSide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        centerEmailCheck = getIntent().getStringExtra("emailX");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(listReviews.isEmpty()){
                    Toast.makeText(ReviewListUserSide.this, "No Reviews"+centerEmailCheck, Toast.LENGTH_SHORT).show();
                }

                adapter2 = new myAdapterRLCS(ReviewListUserSide.this,listReviews);
