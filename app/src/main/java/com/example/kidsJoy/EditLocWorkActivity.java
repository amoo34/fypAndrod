...
public class EditLocWorkActivity extends FragmentActivity implements OnMapReadyCallback {


    String latpassEditWork;
    String lonpassEditWork;
    double latA,lngA;
    String addressWork;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_loc_work);
        ...
        searchView = findViewById(R.id.sv_editLoc2);
        confirmEditLoc = findViewById(R.id.confirmEditLoc2);
        getCurrent = (ImageButton) findViewById(R.id.IBgetCrnt2);
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapEditLoc2);
        locationManager = (LocationManager) getSystemService(LOCATION_SERVICE);

        fusedLocationProviderClient = new FusedLocationProviderClient(EditLocWorkActivity.this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(location != null || !location.equals("")){
                    Geocoder geocoder = new Geocoder(EditLocWorkActivity.this);
                    try {
        ...
        confirmEditLoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                latpassEditWork = String.valueOf(latA);
                lonpassEditWork = String.valueOf(lngA);

                addressWork = getCompleteAddress(latA,lngA);
                String currentUserID = ref.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).getKey();
                Map<String, Object> update = new HashMap<>();
                update.put("/" + currentUserID + "/workLocation", addressWork);
                update.put("/" + currentUserID + "/workLocLat", latpassEditWork);
                update.put("/" + currentUserID + "/workLocLon", lonpassEditWork);

                ref.updateChildren(update);



                Intent it = new Intent(EditLocWorkActivity.this,MapsActivity.class);
    ...
    private String getCompleteAddress(double x, double y)       //method for conversion of latitude and longitude to address string
    {
        ...
        String address = "";
        Geocoder geocoder = new Geocoder(EditLocWorkActivity.this, Locale.getDefault());
