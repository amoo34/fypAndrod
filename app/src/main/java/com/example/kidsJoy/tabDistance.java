 ...
 */
public class tabDistance extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_tab_distance,container,false);





        recyclerView = (RecyclerView)v.findViewById(R.id.RVfilterDistanceSD);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(int i=0;i<countArrayList;i++){
                    ...
                    String checkLATalphaS = listDCC.get(i).getLatitude();
                    double checkLATalphaD = Double.parseDouble(checkLATalphaS);
                    String checkLONalphaS = listDCC.get(i).getLongitude();
                    double checkLONalphaD = Double.parseDouble(checkLONalphaS);
                    ...
                    String disAlpha = getDistance(lat_a,lon_a,checkLATalphaD,checkLONalphaD);
                    double distanceAlpha = Double.parseDouble(disAlpha);
                    ...
                    for(int j=i+1 ; j<countArrayList ; j++)
                    {
                        ...
                        String checkLATbetaS = listDCC.get(j).getLatitude();
                        double checkLATbetaD = Double.parseDouble(checkLATbetaS);
                        String checkLONbetaS = listDCC.get(j).getLongitude();
                        double checkLONbetaD = Double.parseDouble(checkLONbetaS);



                        String disBeta = getDistance(lat_a,lon_a,checkLATbetaD,checkLONbetaD);
                        double distanceBeta = Double.parseDouble(disBeta);



                        //Log.d("XON",""+(checkAlpha>checkBeta));

                        if(distanceAlpha>distanceBeta) {
                            Log.d("reached0","x");
